...
const IconsData = [
  { href: "https://github.com/hussain123sahil", Icon: GithubIcon },
  {
    href: "https://www.linkedin.com/in/sahil-hussain-9a092b224",
    Icon: LinkedinIcon,
  },
  { href: "https://www.instagram.com/titof_abdo/", Icon: InstagramIcon },
  { href: "https://leetcode.com/Sahilhussain123/", Icon: YoutubeIcon },
];
    ...
    text-sm  space-y-2  "
        >
          <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
            Designed & Built by Sahil Hussain
          </span>
