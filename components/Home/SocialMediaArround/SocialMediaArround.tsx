      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/hussain123sahil"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/sahil-hussain-9a092b224"} />
            {/* Instagram Icon */}
            <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/titof_abdo/"} />
            {/* Youtube Icon */}
            <IconClickableWithAnimation Icon={YoutubeIcon} href={"https://leetcode.com/Sahilhussain123/"} />
          </div>
