...
export default function AboutMe(props) {
  const technologies = [
    ["MongoDB", "Next.js","React.js","JavaScript (ES6+)", "Tailwind CSS"],
    ["Express.js", "Node.js","Swiper", "TypeScript", "Framer Motion"],
  ];
  return (
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400  tracking-wide">
                Hello! My name is Sahil Hussain and I enjoy solving problems and creating codes that live on the internet.
                My interest in computer science started back in 2020 when I decided to try learning{" "}
          ...
          <div className="group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden ">
            ...
            <div className="absolute w-5/6 h-5/6  rounded overflow-hidden">
              ...
              <Img src={"/img/sahil-img.jpg"} className={"object-contain rounded-lg"} alt="My Image Not Found" />
            </div>
          </div>
          {/* // ?Image in Mobile */}
